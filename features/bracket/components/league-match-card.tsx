  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex-1 text-right truncate pr-4 font-medium transition-colors ${
            isAWin ? "text-green-400 font-bold" : "text-slate-300"
          }`}
        >
          {p1?.name || "TBD"}
        </div>
        ...
        <div
          className={`px-4 py-1.5 rounded-lg font-mono font-bold text-sm min-w-[70px] text-center border transition-colors ${
        ...
        <div
          className={`flex-1 text-left truncate pl-4 font-medium transition-colors ${
            isBWin ? "text-green-400 font-bold" : "text-slate-300"
          }`}
        >
          {p2?.name || "TBD"}
        </div>
