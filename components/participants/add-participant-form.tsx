    ...
    <div className="p-6 rounded-2xl bg-slate-900/50 border border-white/10 backdrop-blur-sm mb-8">
      ...
      <form ref={formRef} action={handleSubmit} className="flex flex-col md:flex-row gap-4 items-end">
        ...
        <div className="w-full md:flex-1 space-y-2">
          <label className="text-xs font-medium text-slate-400 uppercase tracking-wider">Nama Tim / Pemain</label>
        ...
        <div className="w-full md:w-1/3 space-y-2">
          <label className="text-xs font-medium text-slate-400 uppercase tracking-wider">Info Kontak (Opsional)</label>
          <div className="relative">
